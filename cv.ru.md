---
layout: page
title: "научные публикации и патенты"
date: 2023-12-30
lang: ru
permalink: /cv/
---

Полный список можно посмотреть на [google scholar]({{site.author.scholar}}). Ниже я выделил три отдельных блока: публикации и патенты по старению, а также публикации по физике.
...
**A.E. Tarkhov.** [*Ergodization dynamics of the Gross-Pitaevskii equation on a lattice*](https://www.skoltech.ru/en/education/phd-defenses/2020-2/andrei-tarkhov/) (Кандидатская диссертация). Сколковский институт науки и технологий, Москва, Россия (2020).
